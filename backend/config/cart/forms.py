    ...
    def __init__(self, *args, product=None, **kwargs):
        ...
        if product:
            ...
            if sizes.exists():
                ...
                # Если нет размеров, скрываем поле и добавляем ошибку в форму
                self.fields['size_id'].widget = forms.HiddenInput()
                self.fields['size_id'].required = False
                self.add_error(None, "Товар временно недоступен")
